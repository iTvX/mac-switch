...
final class PackageSmokeTests: XCTestCase {
    ...
    func testPreferencesWindowIsVerticallyResizableAndScreenClamped() throws {
        ...
        XCTAssertTrue(appDelegate.contains("private func resizePreferencesWindowVertically("))
        ...
        XCTAssertTrue(appDelegate.contains("PreferencesVerticalResizeHandleView(edge: .top)"))
        ...
        XCTAssertTrue(appDelegate.contains("resizeHandler?(edge, initialFrame, deltaY)"))
