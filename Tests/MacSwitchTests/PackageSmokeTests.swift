...
final class PackageSmokeTests: XCTestCase {
    ...
    func testReleaseScriptKeepsSigningNotaryAndArchiveGuards() throws {
        ...
        XCTAssertTrue(script.contains("NOTARY_APPLE_ID"), "release script should support direct Apple ID notarization credentials")
        XCTAssertTrue(script.contains("NOTARY_TEAM_ID"), "release script should support direct team ID notarization credentials")
        XCTAssertTrue(script.contains("NOTARY_PASSWORD"), "release script should support app-specific notarization passwords")
        XCTAssertTrue(script.contains("--apple-id"), "release script should pass direct Apple ID credentials to notarytool")
