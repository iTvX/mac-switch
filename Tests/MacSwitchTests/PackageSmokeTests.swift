...
final class PackageSmokeTests: XCTestCase {
    ...
    func testPreferencesWindowIsVerticallyResizableAndScreenClamped() throws {
        ...
        XCTAssertTrue(appDelegate.contains("styleMask: [.titled, .closable, .miniaturizable, .resizable, .fullSizeContentView]"))
        ...
        XCTAssertTrue(appDelegate.contains("private func installPreferencesHorizontalResizeSuppressors(on window: NSWindow)"))
        XCTAssertTrue(appDelegate.contains("installPreferencesHorizontalResizeSuppressors(on: window)"))
        XCTAssertTrue(appDelegate.contains("private final class HorizontalResizeCursorSuppressorView: NSView"))
        XCTAssertTrue(appDelegate.contains("static let edgeWidth: CGFloat = 6"))
        XCTAssertTrue(appDelegate.contains("leftEdge.widthAnchor.constraint(equalToConstant: HorizontalResizeCursorSuppressorView.edgeWidth)"))
        XCTAssertTrue(appDelegate.contains("rightEdge.widthAnchor.constraint(equalToConstant: HorizontalResizeCursorSuppressorView.edgeWidth)"))
        XCTAssertTrue(appDelegate.contains("addCursorRect(bounds, cursor: .arrow)"))
        XCTAssertTrue(appDelegate.contains("override func cursorUpdate(with event: NSEvent)"))
        XCTAssertTrue(appDelegate.contains("NSCursor.arrow.set()"))
        XCTAssertTrue(appDelegate.contains("bounds.contains(point) ? self : nil"))
        ...
        XCTAssertFalse(appDelegate.contains("makePreferencesContentController("))
        XCTAssertFalse(appDelegate.contains("PreferencesVerticalResizeHandleView"))
        XCTAssertFalse(appDelegate.contains("PreferencesVerticalResizeEdge"))
        XCTAssertFalse(appDelegate.contains("verticalResizeCursor"))
        XCTAssertFalse(appDelegate.contains("preferencesResizeTimer"))
        XCTAssertFalse(appDelegate.contains("window.contentView?.viewWillStartLiveResize()"))
